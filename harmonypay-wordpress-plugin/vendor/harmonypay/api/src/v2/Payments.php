	...
	extends Component
{
	...
	**/
	...
	/**
		@brief		Refund a payment on the API.
		@since		2021-07-30 18:20:33
	**/
	public function refund( $payment_id )
	{
		$json = $this->api()->send_post_with_account( 'payment/refund/' . $payment_id, [] );
		return true;
	}
	...
	/**
		...
		@since		2021-07-30 18:20:33
	**/
	public abstract function refund_local( Payment $payment );
