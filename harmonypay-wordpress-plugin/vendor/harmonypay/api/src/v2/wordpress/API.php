	...
	extends \harmonypay\api\v2\API
{
	...
	**/
	...
	{
		return call_user_func_array( [ HarmonyPay(), 'debug' ], func_get_args() );
	}
	...
	**/
	...
	{
		HarmonyPay()->delete_site_option( $key );
		return $this;
	}
	...
	**/
	...
	{
		return HarmonyPay()->get_site_option( $key );
	}
	...
	**/
	...
	{
		return HarmonyPay()->get_client_url();
	}
	...
	**/
	...
	{
		$r = array_merge( [
			'sslverify' => ( ! defined( 'HARMONYPAY_API_NOSSLVERIFY' ) ),
			'timeout' => 60,
		], $args );
		return $r;
	}
	...
	**/
	public function new_account()
	{
		...
		$r = apply_filters( 'harmonypay_api_account', $r );
		return $r;
	}
	...
	**/
	...
	{
		HarmonyPay()->update_site_option( $key, $data );
		return $this;
	}
	...
	**/
	...
	{
		HarmonyPay()->debug( 'HARMONYPAY_API_URL: %s', HARMONYPAY_API_URL );
		$url = sprintf( '%s%s', static::get_api_url(), $url );
