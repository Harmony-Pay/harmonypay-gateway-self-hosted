...
class WC_Gateway_MyCryptoCheckout extends \WC_Payment_Gateway
{
	...
	**/
	public function get_form_fields()
	{
		...
		$r[ 'enabled' ] = [
			...
			'label'       => __( 'Enable HarmonyPay', 'mycryptocheckout' ),
			'type'        => 'checkbox',
			'description' => '',
			'default'     => 'no',
		];
		$r[ 'test_mode' ] = [
			...
			'label'       => __( 'Allow purchases to be made without sending any payment information to the HarmonyPay API server. No payments will be processed in this mode.', 'mycryptocheckout' ),
			'type'        => 'checkbox',
			'description' => '',
			'default'     => 'no',
		];
	...
	**/
	...
	{
		$r = __( 'Accept cryptocurrency payments directly into your wallet using the HarmonyPay service.', 'mycryptocheckout' );
